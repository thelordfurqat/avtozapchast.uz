  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        //'window.location.href=\'http://avtozapchast.uz/site/order?products=\'+ products'+
         '$.ajax({'+
         'url: \'order\','+
         ...
         '.location.href=\'http://avtozapchast.uz/site/order\''+
         '},'+
         'error: function (res) {'+
         'alert(\'error!!\');'+
             'console.log(res)'+
  ...
  var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price">' + this.price + ' сум</td>' +
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="' + classProductTotal + '">' + total + ' сум</td>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong id="' + idGrandTotal + '"> сум</strong></td>' +
        '<td></td>' +
        '</tr>'
      ...
      if(products.length && discountPrice !== null) {
        $cartTable.append(
          '<tr style="color: red">' +
          '<td></td>' +
          '<td><strong>Итого (С скидки)</strong></td>' +
          '<td></td>' +
          '<td></td>' +
          '<td><strong id="' + idDiscountPrice + '"> сум</strong></td>' +
          '<td></td>' +
          '</tr>'
        );
      }
    ...
    var showGrandTotal = function(){
      $("#" + idGrandTotal).text( ProductManager.getTotalPrice()+ " Сум");
    }
    var showDiscountPrice = function(){
      $("#" + idDiscountPrice).text(options.getDiscountPrice(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity()) + " Сум");
    }
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text(price * quantity + " cум");
